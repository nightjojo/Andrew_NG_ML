...
%both Theta1 and Theta2 contains items for bias unit, thus index should start from 2
...
for t = 1:m
	...
	%DELTA := DELTA + a_l * delta_l+1
	delta_accum_1 = delta_accum_1 + delta_2(2:end)' * a_1; %remove bias unit
	delta_accum_2 = delta_accum_2 + delta_3' * a_2;
end;

% 1/m * DELTA (gradient w/o regularization)
Theta1_grad = delta_accum_1 / m; 
Theta2_grad = delta_accum_2 / m;

% add regularization term for j != 0
